			...
			<div class="box3">
				...
				<div class="box3-req">
					...
					<div class="button_bot">
						...
						<button style="width: 150px; font-size: 30px;" class="btn btn-md btn-danger" onclick="del_req(<?php echo "'$username'" ?>)">Reject</button>
					</div>
				</div>
					...
					<div class="modal-dialog">
						<div class="modal-content" style="width: 800px; margin-left: -145px;">
							...
							<div class="modal-body" style="padding:20px;">
								...
								<p style="margin:0; font-size: 40px;">Owner : <?php echo $owner ?></p>
				...
				<div class="modal fade" id="accept" role='dialog'>
					<div class="modal-dialog">
						<div class="modal-content" style="height: 350px; width: 700px; margin-left: -100px;">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-danger" data-dismiss="modal" data-toggle="modal" data-target="#seemore" style="font-size: 40px;">Back</button>
